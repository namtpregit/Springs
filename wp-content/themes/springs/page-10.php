...
?>
        ...
        <div class="container-c">
            <div class="box">
                <div class="top">
                    ...
                    <div class="right">
                        <h4 class="text"><span class="up">The <span class="u">W</span>ellspring to</span> <fade
                                class="down">an Abundant <span class="u">F</span>uture.</span></h4>
                        <img src="<?php bloginfo('template_directory'); ?>/vendor/imgs/img-2.jpg" alt="" class="img" data-aos="fade-in">
                    </div>
                </div>
                <div class="bottom">
                    <span class="title">NEWS</span> | <span class="date">2023.11.20</span> <span
                        class="text">ホームページを更新しました。</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <div style="width: 100%; overflow: hidden;">
        ...
        <section id="impress">
            <div class="content">
                <h3 class="title title-base">あなたに寄り添い、企業に寄り添い、
                    人々に感動を。</h3>
                <div class="text">
            ...
            <div class="list">
                <div class="item">
                    <div class="content">
                        ...
                        <h4 class="title">不動産運用<span>（土地・建物の売買）</span></h4>
                        <p class="desc">土地・建物の最適な運用をサポート。購入から売却まで、一貫して心を込めてアドバイス致します。

                            提携不動産会社
                            ：https://www.kencorp.co.jp/</p>
                    </div>
                ...
                <div class="item">
                    <div class="content">
                        ...
                        <h4 class="title">ヘルスケア・フェムテックサポート</h4>
                        <p class="desc">医療機関・美容クリニック・会員制メディカルクラブのご紹介
                            ...
                            提携クリニック：https://senshin-clinic.com/</p>
                    </div>
                    <div class="box-img js-parallax">
                ...
                <div class="item">
                    <div class="content">
                        ...
                        <h4 class="title">転職支援、リタイアプラン</h4>
                ...
                <div class="item">
                    <div class="content">
                        ...
                        <h4 class="title">不動産、M&Aコンサルティング</h4>
                        <p class="desc">不動産とM&Aの両方に関する深い知識で、資産の最適な運用や事業の拡大戦略をアドバイス致します。</p>
                    </div>
                    <div class="box-img js-parallax">
                ...
                <div class="item">
                    <div class="content">
                        ...
                        <h4 class="title">美術品、ビンテージワインのご売却</h4>
                        <p class="desc">美術品やワインの鑑賞を愛する心で、最適な売却先をご提案。高価買取を目指し、お手伝い致します。</p>
                    </div>
                    <div class="box-img js-parallax">
            ...
            <div class="table-div">
                <div class="list">
                    ...
                    <div class="item">
                        ...
                        <div class="desc">〒104-0061
                            　東京都中央区銀座７丁目17番2号
                            アーク銀座ビルディング6F</div>
                    </div>
                    <div class="item">
                        <div class="title">事業</div>
                        <div class="desc">・不動産売買コンサルティング
                            ・都市開発事業
                            ・﻿事業売買、M&Aコンサルティング
                            ・﻿資産継承アドバイス
                            ・勇退・リタイアプランニング
                            ・ 美術品・ビンテージワインの売買コンサルティング
                            ・アスリート支援
                            ・﻿社会貢献活動</div>
                    </div>
                </div>
        ...
        <div class="container-c">
            <div class="box">
                <div class="box-title">
                    ...
                    <div class="desc">弊社のホームページをご覧いただき、誠にありがとうございます。
                        ご質問・ご相談・お見積りなど、お気軽にご連絡ください。
                    </div>
                    <ul class="ul">
